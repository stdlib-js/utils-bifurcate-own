...
```javascript
import bifurcateOwn from 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-bifurcate-own@v0.1.0-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/utils-bifurcate-own/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/utils-bifurcate-own/actions/workflows/test.yml?query=branch:v0.1.0
